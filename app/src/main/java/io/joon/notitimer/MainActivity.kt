...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Intent(this, MainActivity::class.java)
            .let{
                pendingIntent =  PendingIntent.getActivity(this, 0, it, PendingIntent.FLAG_UPDATE_CURRENT)
        }
        time_editText.setText("3000")
    ...
    private fun build() = NotificationTimer.Builder(this)
